...
employee1 = Employee("Chandu", "andra Family", 50000, "HR")

employee2 = Employee("Shirish", "Bandi Family", 60000, "Finance")



fulltime_employee = FulltimeEmployee("Charan", "Kanchi Family", 70000, "IT", 40)
